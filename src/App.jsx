        ...
        <div>
          ...
          <div style={{padding:"14px 16px 0",maxWidth:480,margin:"0 auto"}}>
            ...
            {sortedDates.map(date=>{
              const isCollapsed = summaryOnly || !!collapsedDays[date];
                ...
                <div key={date} style={{marginBottom:28}}>
                  ...
                  <div
                    ...
                    <div style={{marginLeft:10,marginTop:2,fontSize:18,color:textPrimary,opacity:0.6,flexShrink:0}}>
                      {isCollapsed&&!summaryOnly ? "▶" : summaryOnly ? "" : "▼"}
                    </div>
                  </div>
                  {/* Entries list — hidden when collapsed */}
                  {!isCollapsed && !summaryOnly && entries.sort((a,b)=>b.time.localeCompare(a.time)).map(f=>(
                    f._type === "couche"
