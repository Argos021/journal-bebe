            ...
            <div style={{display:"flex",gap:8}}>
              ...
              {[
                ...
                <button key={mode} onClick={()=>setViewModeAndSave(mode)}
                  title={tip}
                  style={{padding:"7px 11px",borderRadius:20,border:`1.5px solid ${viewMode===mode?(dark?"#f48fb1":"#e8906a"):borderColor}`,background:viewMode===mode?(dark?"rgba(244,143,177,0.15)":"rgba(232,144,106,0.1)"):"transparent",color:viewMode===mode?(dark?"#f48fb1":"#e8906a"):textSecondary,fontWeight:"bold",fontSize:13,cursor:"pointer"}}>
                  {icon}
                </button>
              ))}
