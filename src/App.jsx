                ...
                <div style={{background:cardBg,borderRadius:14,padding:14,boxShadow:"0 2px 12px rgba(0,0,0,0.07)"}}>
                  ...
                  {(journalGraphMode==="mois"||journalGraphMode==="annee") && (
                    <div style={{height:36,display:"flex",alignItems:"center",justifyContent:"center"}}>
                      <span style={{fontSize:11,color:dark?"#555":"#ccc"}}>
                        {journalGraphMode==="mois"?"Vue mensuelle":"Vue annuelle — "+jYear}
                      </span>
                    </div>
                  )}
                  {jData.length>0 ? (
                        ...
                        {jData.map((d,i)=>{
                          ...
                          return (
                            <g key={i}>
                              ...
                              {d.val>0&&(rotL ? (() => {
                                const cx2 = x+w/2;
                                const barH2 = Math.max(1,gH2eff-(pY2(d.val)-pT));
                                const ty2 = pY2(d.val) + Math.min(barH2/2, 14);
                                return (
                                  <text
    ...
    <div style={{padding:"16px",maxWidth:480,margin:"0 auto",paddingBottom:100}}>
      ...
      <div style={{background:cardBg,borderRadius:14,padding:14,marginBottom:14,boxShadow:"0 2px 12px rgba(0,0,0,0.07)"}}>
        ...
        {(graphMode==="mois"||graphMode==="annee") && (
          <div style={{height:36,display:"flex",alignItems:"center",justifyContent:"center"}}>
            <span style={{fontSize:11,color:dark?"#555":"#ccc"}}>
              {graphMode==="mois"?"Vue mensuelle":"Vue annuelle — "+graphYear}
            </span>
          </div>
        )}
        {graphData.length>0 ? (() => {
            ...
            {graphData.map((d,i)=>(
              <g key={i}>
                ...
                {d.val>0&&(rotateLabels ? (() => {
                  ...
                  const barH = Math.max(1,gHeff-(pyR(d.val)-padT));
                  // Place label inside bar, 4px from top, centered on bar width
                  const ty = pyR(d.val) + Math.min(barH/2, 14);
                  return (
                    <text
