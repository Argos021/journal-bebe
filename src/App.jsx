                        ...
                        {jData.map((d,i)=>{
                          ...
                          return (
                            <g key={i}>
                              ...
                              {d.val>0&&(rotL ? (
                                <text x={x+w/2} y={pY2(d.val)-3} textAnchor="start" fontSize={8} fill={dark?"#f48fb1":"#c2185b"} fontWeight="bold"
            ...
            {graphData.map((d,i)=>(
              <g key={i}>
                ...
                {d.val>0&&(rotateLabels ? (
                  <text x={pxBar(i,graphData.length)+barW(graphData.length)/2} y={pyR(d.val)-3} textAnchor="start" fontSize={8} fill={dark?"#90caf9":"#1565c0"} fontWeight="bold"
