...
// ── Main App ─────────────────────────────────────────────────────────────────
export default function BabyTracker({ onSignOut }) {
  ...
  return (
    <div style={{ minHeight:"100vh", background:bg, fontFamily:"'Georgia',serif", padding:"0 0 80px", transition:"background 0.3s" }}>
      ...
      {tab==="options" && (
        <div style={{padding:"16px",maxWidth:480,margin:"0 auto"}}>
          ...
          {/* Logout */}
          <SectionCard dark={dark} cardBg={cardBg}>
            <div style={{fontSize:13,fontWeight:"bold",color:textPrimary,marginBottom:8}}>🔐 Compte</div>
            <button onClick={onSignOut} style={{width:"100%",padding:"12px 0",borderRadius:12,border:"2px solid #e53935",background:"transparent",color:"#e53935",fontSize:15,fontWeight:"bold",cursor:"pointer"}}>
              🚪 Se déconnecter
            </button>
          </SectionCard>
